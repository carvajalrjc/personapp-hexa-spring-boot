...
public class ProfesionControllerV1 {
	...
	public ResponseEntity<?> actualizarProfesion(@PathVariable String database, @PathVariable int id, 
	...
	public ResponseEntity<?> contarProfesiones(@PathVariable String database) {
		...
		return professionInputAdapterRest.contarProfesiones(database.toUpperCase());
	}
}
