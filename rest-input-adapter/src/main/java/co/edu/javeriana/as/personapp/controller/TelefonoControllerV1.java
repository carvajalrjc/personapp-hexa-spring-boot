...
public class TelefonoControllerV1 {
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.NOT_FOUND)
					.body(new Response(String.valueOf(HttpStatus.NOT_FOUND), 
							"The phone with number " + number + " does not exist in the database", 
							LocalDateTime.now()));
		}
	}
	...
	public ResponseEntity<?> actualizarTelefono(@PathVariable String database, @PathVariable String number, 
